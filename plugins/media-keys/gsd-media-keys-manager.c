                    ...
                    gint64               timestamp)
{
        ...
        if (term)
        execute (manager, term, timestamp);
...
do_logout_action (GsdMediaKeysManager *manager,
                  gint64               timestamp)
{
        execute (manager, "gnome-session-quit --logout", timestamp);
}
                      ...
                      gint64               timestamp)
{
    switch (type){
        case SCREENSHOT_KEY:
            execute (manager, "gnome-screenshot", timestamp);
            break;
        case WINDOW_SCREENSHOT_KEY:
            execute (manager, "gnome-screenshot --window", timestamp);
            break;
        case AREA_SCREENSHOT_KEY:
            execute (manager, "gnome-screenshot --area", timestamp);
            break;
        case SCREENSHOT_CLIP_KEY:
            execute (manager, "gnome-screenshot --clipboard", timestamp);
            break;
        case WINDOW_SCREENSHOT_CLIP_KEY:
            execute (manager, "gnome-screenshot --window --clipboard", timestamp);
            break;
        case AREA_SCREENSHOT_CLIP_KEY:
            execute (manager, "gnome-screenshot --area --clipboard", timestamp);
    }
}
